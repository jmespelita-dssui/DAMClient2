...
import { CForm, CFormSelect, CCol, CButton, CModal, CModalHeader, CModalTitle, CModalBody } from '@coreui/react'
  ...
  return (
    <>
      <CModal visible={visible} backdrop="static" onClose={onClose}>
        ...
        <CModalBody>
          <CForm className="add-user row g-3 needs-validation justify-content-center" onSubmit={() => onAdd(device)}>
            <CCol md={7}>
              <CFormSelect
