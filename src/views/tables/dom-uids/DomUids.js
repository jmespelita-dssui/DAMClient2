...
const DomUids = () => {
  ...
  const fetchData = async () => {
    ...
    axios.get('https://dssui-asset-manager.herokuapp.com/api/dom-uids').then((response) => {
  ...
  const addDomUid = (domUid) => {
    axios
      .post('https://dssui-asset-manager.herokuapp.com/api/add-dom-uid', {
  ...
  const deleteDomUid = (id) => {
    axios
      .delete(`https://dssui-asset-manager.herokuapp.com/api/delete-dom-uid/${id}`)
      .then(() => {
